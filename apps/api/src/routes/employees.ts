...
const employeeInputShape = {
  ...
  maritalStatus: z.enum(['BELUM_KAWIN', 'KAWIN', 'CERAI_HIDUP', 'CERAI_MATI', 'SINGLE', 'MARRIED', 'DIVORCED', 'WIDOWED']).optional(), religion: optional, educationLevel: educationLevelSchema, address: optional, rtrw: optionalRtrw, kelurahan: optional, kecamatan: optional, city: optional, province: optional,
