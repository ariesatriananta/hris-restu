...
export function ContractPrintPage({ contractUid }: { contractUid: string }) {
  ...
  return (
    <main className='contract-print-root min-h-screen bg-muted p-4 print:bg-white print:p-0'>
      ...
      <article className='mx-auto min-h-[297mm] max-w-[210mm] bg-white p-[18mm] text-[10.5pt] leading-[1.55] text-black shadow print:shadow-none'>
        ...
        <section className='mt-5 space-y-2.5'>
          ...
          <p>
            ...
            {data.company.site}, terhitung sejak{' '}
            {date(data.contract.startDate)} sampai dengan{' '}
            {date(data.contract.endDate)}.
          </p>
          ...
          <p>
            Imbalan PIHAK KEDUA dihitung berdasarkan hasil pekerjaan yang
            diterima perusahaan. Tarif yang disepakati adalah:
          </p>
            ...
            <tbody>
              {data.jobs.map((job, index) => (
                <tr key={job.uid}>
                  ...
                  <td className='border border-black/60 px-2 py-1'>
                    {job.name}
                  </td>
                  <td className='border border-black/60 px-2 py-1'>
                    {job.unit}
          ...
          <p>
            Pembayaran hasil produksi dilakukan{' '}
            {data.payment.schedule.toLowerCase()} berdasarkan hasil yang telah
          ...
          <p>
            ...
            keselamatan kerja, tata tertib, dan ketentuan operasional
            perusahaan. PIHAK PERTAMA berhak melakukan evaluasi atas hasil
            pekerjaan.
          </p>
          ...
          <p>
            ...
            mempunyai kekuatan hukum yang sama setelah ditandatangani para
            pihak.
          </p>
        </section>
